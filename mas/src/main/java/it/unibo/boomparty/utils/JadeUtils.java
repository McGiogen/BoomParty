...
public class JadeUtils {
     ...
     * this agent shows the state of the Agent Platform it belongs to (agents and agent containers)
     ...
     * find other agents providing the services he requires in order
     */
